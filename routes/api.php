...
Route::prefix('app-tv')->group(function () {
    ...
    // TV-LINK-QR-API-V54
    Route::post('tv-link/generate', [\App\Http\Controllers\AppTv\TvLinkController::class, 'generate']);
    Route::post('tv-link/poll', [\App\Http\Controllers\AppTv\TvLinkController::class, 'poll']);
});
